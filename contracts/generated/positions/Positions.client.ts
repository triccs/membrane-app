...
export interface PositionsReadOnlyInterface {
  ...
  getBasketRedeemability: ({
    ...
    startAfter?: number;
  }) => Promise<GetBasketRedeemabilityResponse>;
  getBasketPositions: ({
    limit,
    startAfter,
    user,
    ...
    user?: string;
    userInfo?: UserInfo;
  }) => Promise<GetBasketPositionsResponse>;
  getBasket: () => Promise<GetBasketResponse>;
  getBasketDebtCaps: () => Promise<GetBasketDebtCapsResponse>;
  getCreditRate: () => Promise<GetCreditRateResponse>;
  getCollateralInterest: () => Promise<GetCollateralInterestResponse>;
}
export class PositionsQueryClient implements PositionsReadOnlyInterface {
  ...
  getBasket = async (): Promise<GetBasketResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_basket: {}
    });
  };
  getBasketDebtCaps = async (): Promise<GetBasketDebtCapsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_basket_debt_caps: {}
    });
  };
  getCreditRate = async (): Promise<GetCreditRateResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_credit_rate: {}
    });
  };
  getCollateralInterest = async (): Promise<GetCollateralInterestResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
